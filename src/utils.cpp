...
std::string save_solid_obj_string(std::vector<std::vector<double>> &front_points, std::vector<std::vector<double>> &back_points, std::vector<std::vector<int>> &triangles, double thickness, double width, double height, int res_x, int res_y) {   
    ...
    svg_string.append("# Generated by the software algorithm written by Dylan Missuwe\n");
    svg_string.append("# The algorithm used to create the lens is based on the paper ");
    svg_string.append("\"Poisson-Based Continuous Surface Generation for Goal-Based Caustics\" ");
    svg_string.append("by Yue et al (2014)\n");

    // Curved mesh verts on the bottom
    for (const auto& point : front_points) {
        svg_string.append("v ");
        svg_string.append(std::to_string(width - point[0]));
        svg_string.append(" ");
        svg_string.append(std::to_string(height - point[1]));
        svg_string.append(" ");
        svg_string.append(std::to_string(-point[2]));
        svg_string.append("\n");
        //file << "v " << width - point[0] << " " << height - point[1] << " " << -(point[2]) << "\n";
    }
    ...
    for (const auto& point : back_points) {
        ...
        svg_string.append(std::to_string(height - point[1]));
        svg_string.append(" ");
        svg_string.append(std::to_string(-thickness - min_h));
        svg_string.append("\n");
        //file << "v " << width - point[0] << " " << height - point[1] << " " << -thickness - min_h << "\n";
    }
    ...
    for (const auto& triangle : triangles) {
        svg_string.append("f ");
        svg_string.append(std::to_string(triangle[0] + 1));
        svg_string.append(" ");
        svg_string.append(std::to_string(triangle[1] + 1));
        svg_string.append(" ");
        svg_string.append(std::to_string(triangle[2] + 1));
        svg_string.append("\n");
        //file << "f " << triangle[0] + 1 << " " << triangle[1] + 1 << " " << triangle[2] + 1 << "\n";
    }
    ...
    for (const auto& triangle : triangles) {
        svg_string.append("f ");
        svg_string.append(std::to_string(triangle[0] + num_points + 1));
        svg_string.append(" ");
        svg_string.append(std::to_string(triangle[1] + num_points + 1));
        svg_string.append(" ");
        svg_string.append(std::to_string(triangle[2] + num_points + 1));
        svg_string.append("\n");
        //file << "f " << triangle[0] + num_points + 1 << " " << triangle[2] + num_points + 1 << " " << triangle[1] + num_points + 1 << "\n";
    }
    ...
    for (size_t i = 0; i < perimeter_verts.size(); ++i) {
        ...
        svg_string.append("f ");
        svg_string.append(std::to_string(top_idx + 1));
        svg_string.append(" ");
        svg_string.append(std::to_string(bottom_idx + 1));
        svg_string.append(" ");
        svg_string.append(std::to_string(next_bottom_idx + 1));
        svg_string.append("\n");
        ...
        svg_string.append(std::to_string(next_bottom_idx + 1));
        svg_string.append(" ");
        svg_string.append(std::to_string(next_top_idx + 1));
        svg_string.append("\n");
